...
namespace MyFlightbook.ImportFlights
{
    ...
    {
        private static ExternalFormatImporter[] rgFormatters = { new LogTenProImporter(), new ForeFlightImporter(), new eLogSiteImporter(), new CrewTracImporter(), new RosterBusterImporter() };
