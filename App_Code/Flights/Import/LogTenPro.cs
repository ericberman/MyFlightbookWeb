    ...
    public class LogTenPro : ExternalFormat
    {
        ...
        public override LogbookEntry ToLogbookEntry()
        {
            ...
            le.CustomProperties = PropertiesWithoutNullOrDefault(new CustomFlightProperty[] {
                ...
                PropertyWithValue(CustomPropertyType.KnownProperties.IDPropDutyTimeStart, flight_onDutyTime, true),
                PropertyWithValue(CustomPropertyType.KnownProperties.IDPropDutyTimeEnd, flight_offDutyTime, true),
