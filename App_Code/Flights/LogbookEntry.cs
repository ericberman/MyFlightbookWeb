...
namespace MyFlightbook
{
    ...
    public class LogbookEntry : IPostable
    {
            ...
            dbh.DoNonQuery(
                (comm) =>
                {
                    ...
                    if (fUpdateSignature)
                    {
                        ...
                        comm.Parameters.AddWithValue("cficomment", this.CFIComments);
        ...
        {
            return String.Format(CultureInfo.InvariantCulture, "~/Public/ViewPublicFlight.aspx/{0}", FlightID).ToAbsoluteURL("http", szHost ?? Branding.CurrentBrand.HostName);
        }
