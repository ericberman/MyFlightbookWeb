<%@ Page Title="Sign an entry" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Codebehind="SignEntry.aspx.cs" Inherits="MyFlightbook.Instruction.SignEntryPublic" %>
