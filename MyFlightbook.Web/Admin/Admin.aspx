...
WHERE man.DefaultSim &lt;&gt; 0 AND m.fSimOnly= 0"></asp:SqlDataSource>
            ...
            <asp:GridView ID="gvOrphanMakes" runat="server"
                AutoGenerateDeleteButton="True" DataKeyNames="idmodel,idmanufacturer" CellPadding="3" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="typename" HeaderText="Type Rating" 
                        SortExpression="typename" />
                    <asp:BoundField DataField="idmodel" HeaderText="idmodel" ReadOnly="True" 
                        SortExpression="idmodel" />
                    <asp:BoundField DataField="idcategoryclass" HeaderText="Cat/Class ID" 
                        SortExpression="idcategoryclass" />
                    <asp:BoundField DataField="idmanufacturer" HeaderText="Mfr. ID" 
                        ReadOnly="True" SortExpression="idmanufacturer" />
                    <asp:BoundField DataField="modelname" HeaderText="Mktg Name" 
                        SortExpression="modelname" />
                    <asp:BoundField DataField="fcomplex" HeaderText="Complex" 
                        SortExpression="fcomplex" />
                    <asp:BoundField DataField="fHighPerf" HeaderText="High Perf" 
                        SortExpression="fHighPerf" />
                    <asp:BoundField DataField="fTailwheel" HeaderText="Tailwheel" 
                        SortExpression="fTailwheel" />
                    <asp:BoundField DataField="fConstantProp" HeaderText="CS Prop" 
                        SortExpression="fConstantProp" />
                    <asp:BoundField DataField="fTurbine" HeaderText="Turbine" 
                        SortExpression="fTurbine" />
                    <asp:BoundField DataField="fRetract" HeaderText="Retract" 
                        SortExpression="fRetract" />
                    <asp:BoundField DataField="fCowlFlaps" HeaderText="Flaps" 
                        SortExpression="fCowlFlaps" />
                    <asp:BoundField DataField="fGlassOnly" HeaderText="fGlassOnly" SortExpression="Glass" />
                    <asp:BoundField DataField="fSimOnly" HeaderText="fSimOnly" SortExpression="SimOnly" />
                </Columns>
            </asp:GridView>
