...
<div>
    ...
    <div class="imageMenu" runat="server" id="divActions">
        <div runat="server" id="divDel">
            <asp:ImageButton ID="lnkDelete" CssClass="ilToolbarItem" ImageUrl="~/images/x.gif" runat="server" Visible="false" ToolTip="<%$ Resources:LocalizedText, EditableImageDelete %>" AlternateText="<%$ Resources:LocalizedText, EditableImageDelete %>" OnClick="DeleteImage" />
            <cc1:ConfirmButtonExtender ID="cbeDelete" runat="server" Enabled="false" TargetControlID="lnkDelete" />
        </div>
