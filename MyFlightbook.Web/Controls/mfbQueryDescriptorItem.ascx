...
<div class="queryFilterItem">
    <asp:Label ID="lblTitle" Font-Bold="true" runat="server" Text=""></asp:Label><asp:Label ID="lblColon" runat="server" Text=": " Visible="false"></asp:Label><asp:Label ID="lblDescriptor" runat="server" Text="Label"></asp:Label>
