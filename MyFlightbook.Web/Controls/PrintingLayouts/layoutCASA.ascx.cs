...
namespace MyFlightbook.Printing.Layouts
{
    public partial class LayoutCASA : PrintLayoutBase
    {
        ...
        protected void rptPages_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            StripRedundantOrExcludedProperties(new int[] { (int)CustomPropertyType.KnownProperties.IDPropStudentName, (int)CustomPropertyType.KnownProperties.IDPropNameOfPIC, (int)CustomPropertyType.KnownProperties.IDPropNightTakeoff }, lep.Flights);
