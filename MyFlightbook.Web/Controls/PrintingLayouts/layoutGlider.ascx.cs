...
{
    public partial class LayoutGlider : PrintLayoutBase
    {
        ...
        protected void rptPages_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            StripRedundantOrExcludedProperties(new int[] { (int) CustomPropertyType.KnownProperties.IDPropSolo }, lep.Flights);
