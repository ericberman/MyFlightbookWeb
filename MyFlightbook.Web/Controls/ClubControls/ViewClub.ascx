        ...
        <div style="width: 100%; max-width: 600px; padding: 3px;">
            <asp:Panel ID="pnlContactDetails" runat="server" CssClass="clubDetailsRight">
                ...
                <asp:Panel ID="pnlHomeAirport" runat="server" Visible='<%# !String.IsNullOrEmpty(Eval("HomeAirportCode").ToString()) %>'>
                    <asp:HyperLink ID="lnkViewAirport" NavigateUrl='<%# VirtualPathUtility.ToAbsolute(String.Format("~/mvc/Airport/MapRoute?sm=1&Airports={0}", Eval("HomeAirport.Code"))) %>' runat="server"><%#: Eval("HomeAirport.Code") %></asp:HyperLink> - <%#: Eval("HomeAirport.Name") %>
                </asp:Panel>
