...
<asp:Panel ID="pnlValidate" runat="server" DefaultButton="btnVerifyCode">
    ...
    <asp:RequiredFieldValidator ID="reDigitsReq" ValidationGroup="tfaCode" runat="server" ErrorMessage="<%$ Resources:Profile, TFAErrCodeFormat %>" ControlToValidate="txtCode" CssClass="error" Display="Dynamic"></asp:RequiredFieldValidator>
    <asp:RegularExpressionValidator ID="reDigits"  ValidationGroup="tfaCode" runat="server" ErrorMessage="<%$ Resources:Profile, TFAErrCodeFormat %>" ControlToValidate="txtCode" CssClass="error" Display="Dynamic" ValidationExpression="\d{6}"></asp:RegularExpressionValidator>
