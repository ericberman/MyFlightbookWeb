...
<asp:MultiView ID="mvTFAState" runat="server">
    <asp:View ID="vwAddTFA" runat="server">
        ...
        <p><span style="font-size:larger; font-weight:bold">2.&nbsp</span><asp:Localize ID="locPickOptions" runat="server" Text="<%$ Resources:Profile, TFATwoOptionsPrompt %>"></asp:Localize></p>
        ...
        <p><span style="font-size:larger; font-weight:bold">3.&nbsp</span><asp:Localize ID="locValidateCode" runat="server" Text="<%$ Resources:Profile, TFAValidateCodePrompt %>"></asp:Localize></p>
        <div style="text-align:center">
    ...
    <asp:View ID="vwTFAActive" runat="server">
        <p><asp:Label ID="lblTFAActive" runat="server" Font-Bold="true" Text="<%$ Resources:Profile, TFAIsSetUp %>"></asp:Label></p>
