...
{
    public partial class SelectMake : UserControl, INamingContainer
    {
        ...
        {
            get { return cbeEdit.ConfirmText; }
            set
            {
                cbeEdit.ConfirmText = value;
                cbeEdit.Enabled = !String.IsNullOrEmpty(value);
            }
        }
