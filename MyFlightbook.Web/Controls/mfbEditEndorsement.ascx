<%@ Control Language="C#" AutoEventWireup="true" Codebehind="mfbEditEndorsement.ascx.cs" Inherits="MyFlightbook.Instruction.mfbEditEndorsement" %>
...
<asp:Panel ID="pnlEditEndorsement" runat="server" CssClass="endorsement endorsementEdit"  DefaultButton="btnAddEndorsement" >
