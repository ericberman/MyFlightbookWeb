...
{
    public partial class DayNight : System.Web.UI.Page
    {
        ...
        protected void btnTimes_Click(object sender, EventArgs e)
        {
            ...
            for (int h = 0; h < 24; h++)
            {
                ...
                for (int m = 0; m < 60; m += 5)
                {
                    ...
                    tc.Text = String.Format(CultureInfo.CurrentCulture, "{0}, {1:F2}°", dt2.ToString("HH:mm", CultureInfo.InvariantCulture), sst.SolarAngle);
                }
            }
        }
