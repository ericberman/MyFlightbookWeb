...
<asp:Content ID="Content1" ContentPlaceHolderID="cpTopForm" runat="Server">
    ...
    <ul>
        ...
        <li><asp:HyperLink ID="lnkUploadTelemetry" runat="server" Font-Bold="true" NavigateUrl="~/Member/ImportTelemetry.aspx">Bulk Upload Telemetry</asp:HyperLink> - Upload multiple telemetry files and match to existing flights.</li><li><asp:HyperLink ID="lnkAnalyzeDutyPeriods" runat="server" Font-Bold="true" NavigateUrl="~/PlayPen/DutyPeriodAnalyzer.aspx">Duty Period Analyzer</asp:HyperLink> - view duty periods and do simple analysis.</li>
