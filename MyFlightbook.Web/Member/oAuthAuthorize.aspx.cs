...
{
    public partial class OAuthAuthorizeUser : System.Web.UI.Page
    {
        ...
        protected void btnYes_Click(object sender, EventArgs e)
        {
            ...
            MFBOauthClientAuth ca = new MFBOauthClientAuth { Scope = OAuthUtilities.JoinScopes(m_pendingRequest.Scope), ClientId = m_pendingRequest.ClientIdentifier, UserId = Page.User.Identity.Name, ExpirationDateUtc = DateTime.UtcNow.AddYears(10) };
            if (ca.fCommit())
            {
