<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Codebehind="ClubManage.aspx.cs" Inherits="MyFlightbook.Clubs.ClubManage" %>
    ...
    <asp:Accordion ID="accClub" runat="server" HeaderCssClass="accordianHeader" HeaderSelectedCssClass="accordianHeaderSelected" ContentCssClass="accordianContent" TransitionDuration="250" SelectedIndex="-1" RequireOpenedPane="false">
        <Panes>
            <asp:AccordionPane ID="acpMembers" runat="server">
                <Header>
                    <asp:Localize ID="locMembers" runat="server" Text="<%$ Resources:Club, TabClubMembers %>" />
                </Header>
                <Content>
            ...
            <ajaxToolkit:AccordionPane ID="acpAircraft" runat="server">
                <Header>
                    <asp:Localize ID="locAircraft" runat="server" Text="<%$ Resources:Club, TabClubAircraft %>" />
                </Header>
                <Content>
            ...
            <ajaxToolkit:AccordionPane ID="acpDetails" runat="server">
                <Header>
                    <asp:Localize ID="locDetails" runat="server" Text="<%$ Resources:Club, TabClubInfo %>" />
                </Header>
                <Content>
            ...
            <ajaxToolkit:AccordionPane ID="acpReports" runat="server">
                <Header>
                    <asp:Localize ID="locReports" runat="server" Text="<%$ Resources:Club, TabClubReports %>" />
                </Header>
                <Content>
