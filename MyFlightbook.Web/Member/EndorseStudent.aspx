...
<asp:Content ID="ContentTopForm" ContentPlaceHolderID="cpTopForm" runat="server">
    ...
    <asp:Panel ID="pnlError" runat="server" Visible="false">
        ...
        <br />
        <asp:Image ID="ib" ImageAlign="AbsMiddle" ImageUrl="~/images/back.png" runat="server" /><asp:HyperLink ID="lnkReturnHome" NavigateUrl="~/mvc/training/students" runat="server" Text="<%$ Resources:Profile, EndorsementReturnToProfile %>"></asp:HyperLink>
    </asp:Panel>
    <br />
