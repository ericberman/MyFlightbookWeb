       ...
       protected void Application_Start(object sender, EventArgs e)
        {
            ...
            ScriptManager.ScriptResourceMapping.AddDefinition("jqueryUtils", new ScriptResourceDefinition { Path = VirtualPathUtility.ToAbsolute("~/Public/Scripts/jqueryutil.js?v=4") });
