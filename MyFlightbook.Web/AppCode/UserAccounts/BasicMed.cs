...
namespace MyFlightbook.BasicmedTools
{
    ...
    public class BasicMedEvent
    {
        ...
        private static readonly DateTime dtBasicMedCutover = new DateTime(2024, 11, 12, 0, 0, 0);
            ...
            get
            {
                switch (EventType)
                {
                    ...
                    case BasicMedEventType.PhysicianVisit:
                        ...
                        /*
                        // Issue #1317: And, alas, in 2024 this becomes calendar months.
                        Per AOPA:

                         * Jacquie (AOPA) 
                        Oct 17, 2024, 9:02 AM EDT 
                        HI Eric,

                        Effective date is 180 days after the bill was signed, (May 16th, 2024) so Nov. 12. Sec. 828 of the bill.
                        ...
                        180 days from May 16 2024 is Nov 12 2024
                        */
                        return DateTime.Now.Date.CompareTo(dtBasicMedCutover) < 0 ? EventDate.AddYears(4) : EventDate.AddCalendarMonths(48);
                    case BasicMedEventType.Unknown:
                    default:
