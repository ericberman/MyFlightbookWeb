...
#pragma warning restore CA1008 // Enums should have zero value
    ...
    public class AircraftInstance
    {
        ...
        protected AircraftInstance(IDataReader dr) : this()
        {
            if (dr == null)
    ...
    public class Aircraft
    {
        ...
        protected void InitFromDataReader(IDataReader dr)
        {
            if (dr == null)
                throw new ArgumentNullException(nameof(dr));
        ...
        /// <summary>
        /// Updates an existing aircraft.  Intended for use by admin functions that need to bypass cloning, merging, duplicate detection, and so forth, so use with care.
        /// </summary>
        /// <exception cref="InvalidOperationException"></exception>
        public void AdminUpdateInPlace()
        {
            if (IsNew)
                throw new InvalidOperationException("Attempt to update an aircraft that isn't an existing aircraft");
            CommitToDB();
        }
        ...
        private static List<Aircraft> GetSims(int idmodel, Boolean fAllSims, AircraftInstanceTypes instanceType)
        {
