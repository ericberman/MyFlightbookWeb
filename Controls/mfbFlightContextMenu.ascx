...
<div style="line-height: 26px;">
    <asp:LinkButton ID="lnkEditThisFlight" runat="server" OnClick="lnkEditThisFlight_Click">
...
<div style="line-height: 26px">
    <asp:LinkButton ID="lnkRequestSignature" runat="server" OnClick="lnkRequestSignature_Click">
...
<div style="line-height: 26px">
    <asp:LinkButton ID="lnkClone" runat="server" OnClick="lnkClone_Click">
...
<div style="line-height: 26px">
    <asp:LinkButton ID="lnkReverse" runat="server" OnClick="lnkReverse_Click">
