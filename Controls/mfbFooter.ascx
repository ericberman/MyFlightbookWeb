...
<div class="footerContainer">
    <asp:Panel ID="pnlClassic" runat="server" Width="100%"
        ...
        <hr />
        <div class="footerItem"><asp:HyperLink ID="lnkPrivacy" NavigateUrl="~/Public/Privacy.aspx"
            runat="server" Text="Privacy policy" meta:resourcekey="lnkPrivacyResource1"></asp:HyperLink></div>
        <div class="footerItem"><asp:HyperLink ID="HyperLink1" NavigateUrl="~/Public/TandC.aspx" runat="server" 
            Text="Terms of Use" meta:resourcekey="HyperLink1Resource1"></asp:HyperLink></div>
        <div class="footerItem"><asp:HyperLink ID="lnkContact" NavigateUrl="~/Public/ContactMe.aspx" 
        ...
        <div class="footerItem" id="cellFacebook" runat="server">
            <asp:HyperLink ID="lnkFacebook" Target="_blank" runat="server">
                <asp:Label ID="lblFollowFacebook" runat="server" 
                Text="Follow MyFlightbook on Facebook" 
                meta:resourcekey="lblFollowFacebookResource1"></asp:Label>&nbsp;
        ...
        <div class="footerItem" id="cellTwitter" runat="server">
            <asp:HyperLink ID="lnkTwitter" runat="server" Target="_blank">
                <asp:Label ID="lblFollowTwitter" runat="server" Text="Follow MyFlightbook on Twitter" 
                    meta:resourcekey="lblFollowTwitterResource1"></asp:Label>&nbsp;
                <asp:Image ID="imgTwitter" runat="server" Height="16px" Width="16px" 
