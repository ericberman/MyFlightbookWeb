            ...
            <div id="headerSearchAndSign">
                <div id="headerSearchBox">
                    <asp:Panel ID="pnlSearch" runat="server" DefaultButton="btnSearch">
                        <asp:TextBox ID="txtSearch" runat="server" Width="90px" Font-Size="9px"></asp:TextBox>
                        <asp:Button ID="btnSearch" runat="server" Text="<%$ Resources:LocalizedText, SearchBoxGo %>" CausesValidation="false" onclick="btnSearch_Click" Font-Size="9px" CssClass="itemlabel" />
